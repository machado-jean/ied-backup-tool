...
| GE Multilin / EnerVista UR | folders with `.urs` or `.urk`; optional `.ENV` | Highest `GE UR Setup` found in `.cid/.icd`; fallback to `GEMULTILIN` in `.urs/.urk`. |
...
GE-URSETUP-V8.61_SE-AAA_20260712-1100_COLLABORATOR-EXAMPLE_TAF.zip
```
