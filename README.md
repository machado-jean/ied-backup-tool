...
| GE Multilin / EnerVista UR | pastas com `.urs` ou `.urk`; `.ENV` opcional | Usa a maior versão entre headers `GEMULTILIN`/`GEVERNOVA` em `.urs/.urk` e `UR Setup` em `.cid/.icd`, gerando prefixos como `GE-MULTILIN-V8.71`. |
